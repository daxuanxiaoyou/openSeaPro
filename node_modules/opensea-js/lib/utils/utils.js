...
exports.merkleValidatorByNetwork = (_a = {},
    _a[types_1.Network.Main] = constants_1.MERKLE_VALIDATOR_MAINNET,
    _a[types_1.Network.Rinkeby] = constants_1.MERKLE_VALIDATOR_RINKEBY,
    _a);
exports.wyvern2_2ConfigByNetwork = (_b = {},
    _b[types_1.Network.Main] = {
    ...
    _b[types_1.Network.Rinkeby] = {
        wyvernExchangeContractAddress: "0x5206e78b21ce315ce284fb24cf05e0585a93b1d9",
        wyvernProxyRegistryContractAddress: "0xf57b2c51ded3a29e6891aba85459d600256cf317",
        wyvernTokenTransferProxyContractAddress: "0x82d102457854c985221249f86659c9d6cf12aa72",
    },
    _b);
/**
...
var getMaxOrderExpirationTimestamp = function () {
    ...
    maxExpirationDate.setDate(maxExpirationDate.getDate() + constants_1.MAX_EXPIRATION_MONTHS);
